...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280, font=("Arial", 18, "italic"), text="Some Question Text", fill=THEME_COLOR)
    ...
    def check_answer(self, choice):
        value = self.quiz.check_answer(choice)
        if value == True:
